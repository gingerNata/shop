      ...
      <div class="section clearfix">
        <div id="top-header">
          ...
          <?php if ($site_name || $site_slogan): ?>
            <div id="name-and-slogan"<?php if (!empty($hide_site_name) && $hide_site_slogan) {
              print ' class="element-invisible"';
            } ?>>

              <?php if ($site_name): ?>
                <?php if ($title): ?>
                  <div id="site-name"<?php if (!empty($hide_site_name)) {
                    print ' class="element-invisible"';
                  } ?>>
                    <strong>
                ...
                <?php else: /* Use h1 when the content title is empty */ ?>
                  <h1 id="site-name"<?php if (!empty($hide_site_name)) {
                    print ' class="element-invisible"';
                  } ?>>
                    <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"
                       rel="home"><span><?php print $site_name; ?></span></a>
              ...
              <?php if ($site_slogan): ?>
                <div id="site-slogan"<?php if (!empty($hide_site_name)) {
                  print ' class="element-invisible"';
                } ?>>
